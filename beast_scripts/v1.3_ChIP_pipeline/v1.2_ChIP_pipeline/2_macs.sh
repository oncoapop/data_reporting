...
for line in `cat /home/dyap/Scripts/v1.2_ChIP_pipeline/table`
...
/home/dyap/bin/macs2 callpeak --broad --nomodel -t $path/$treatname -c $path/$contname -f BAM -n $name -B --SPMR -g hs --extsize=250 
