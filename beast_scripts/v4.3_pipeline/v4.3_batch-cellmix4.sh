...
# 23 Mar 2015 (get positions preselected against for adjacent SNPs)
/home/dyap/R-patched/bin/Rscript ~/Scripts/v4.3_pipeline/v4.3_GetSeq.R --no-save --no-restore --args $Project"/hTERT/targets_hTERT.tsv"
#/home/dyap/R-patched/bin/Rscript ~/Scripts/v4.3_pipeline/v4.3_GetSeq.R --no-save --no-restore --args $Project"/HCT/targets_HCT.tsv"
#/home/dyap/R-patched/bin/Rscript ~/Scripts/v4.3_pipeline/v4.3_GetSeq.R --no-save --no-restore --args $Project"/Shared/targets_Shared.tsv"

#inputsamples="hTERT HCT Shared"
inputsamples="hTERT"
