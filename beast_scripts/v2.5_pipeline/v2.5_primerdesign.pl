...
print "Writing to /home/dyap/public_html/v2.5_requests\n"; 

open (MYARchIVE,">> /home/dyap/public_html/v2.5_requests") || die "Cannot open Archive";
print MYARchIVE "|";
...
system("mkdir  /home/dyap/Projects/PrimerDesign/$dir/$sample");
system("mkdir  /home/dyap/Projects/PrimerDesign/$dir/$sample/positions");
...
if ($pos eq "hg19") {
	print "File to use /home/dyap/Projects/PrimerDesign/$dir/$sample/positions/$file-hg19";
	print "Please save your file in this location and press ENTER";
        $ans = <>;
	system ("export sample=${'sample'}; export Project=${'dir'}; export name=${'file'};/home/dyap/Scripts/v2.5_pipeline/v2.5_format_webinput.sh");
...
if ($pos eq "hg18") {
	...
	print "File to use /home/dyap/Projects/PrimerDesign/$dir/$sample/positions/$file-hg18";
	print "Please save your file in this location and press ENTER";
	$ans = <>;
	system ("export sample=${'sample'}; export Project=${'dir'}; export name=${'file'};/home/dyap/Scripts/v2.5_pipeline/v2.5_liftover.sh");
    }
...
print("Rscript /home/dyap/Scripts/v2.5_pipeline/v2.5_GetSeq.R --no-save --no-restore --args ${'dir'}/${'sample'}/${'file'}\n");
system("Rscript /home/dyap/Scripts/v2.5_pipeline/v2.5_GetSeq.R --no-save --no-restore --args ${'dir'}/${'sample'}/${'file'}");
...
system ("export sample=${'sample'}; export p3set=${'p3set'}; export hg=${'pos'};export Project=${'dir'}; export name=${'file'}; export Miseq=${'Miseq'};/home/dyap/Scripts/v2.5_pipeline/v2.5_primer3pipeline.sh");
