...
~/Scripts/v3_pipeline/v3_inSilicoPcr.sh
...
Rscript ~/Scripts/v3_pipeline/v3_GetSeq.R --no-save --no-restore --args $Project/$name/$file
...
~/Scripts/v3_pipeline/v3_primer_summary_multi.sh
