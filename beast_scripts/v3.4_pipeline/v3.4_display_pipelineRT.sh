...
# v3.4 using modified v3.1,v3.3 
# for primer design on NMD transcripts
...
~/Scripts/v3.4_pipeline/v3.4_inSilicoPcrRT.sh
#~/Scripts/v3.4_pipeline/v3.4_inSilicoPcr.sh
...
#~/Scripts/v3.4_pipeline/v3.4_primer_summaryRT.sh
~/Scripts/v3.4_pipeline/v3.4_primer_summaryRTN.sh
