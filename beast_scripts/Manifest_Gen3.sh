...
echo The following two numbers must be equal for the Sample_IDs to be unique

cat $outfile99.tmp | awk -F, '{print $1}' | wc -l
cat $outfile99.tmp | awk -F, '{print $1}' | sort -u | wc -l
