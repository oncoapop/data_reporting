...
# Damian's command
#macs2 callpeak --keep-dup 1 --shift 73 --nomodel --extsize 250 -t $treatname -c $contname --broad -g hs -n $name -B 
...
macs2 callpeak --broad --nomodel -t $treatname -c $contname -f BAM -n $name -B --SPMR -g hs --extsize=290 &> $dir/$name.log &
