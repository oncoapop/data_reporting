...
~/Scripts/v4.2_pipeline/v4.2_inSilicoPcr.sh
...
# Rscript ~/Scripts/v4.2_pipeline/v4.2_GetSeq.R --no-save --no-restore --args $Project/$name/$file
...
~/Scripts/v4.2_pipeline/v4.2_primer_summary.sh
