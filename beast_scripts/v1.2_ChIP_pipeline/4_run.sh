...
dir="/home/dyap/dyap_temp/ChIPseqAnalysis3"
...
#-----------------------------DO NOT EDIT ANYTHING BELOW THIS LINE -------------------------------------
        do
         ...
         echo `date` \n >> $dir/jobs.log ; echo $sample "EXPT-"$expt" Started processing." >> $dir/jobs.log
                ...
                Rscript /home/dyap/Scripts/v1.2_ChIP_pipeline/4.1_sushiPlot2.R
                # using IgG as control
                # Rscript /home/dyap/Scripts/v1.2_ChIP_pipeline/4_sushiPlot2.R
...
#/home/dyap/Scripts/v1.2_ChIP_pipeline/5_CopytoBeast.sh
