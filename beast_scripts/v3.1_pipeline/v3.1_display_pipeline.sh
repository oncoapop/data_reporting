...
~/Scripts/v3.1_pipeline/v3.1_inSilicoPcr.sh
...
Rscript ~/Scripts/v3.1_pipeline/v3.1_GetSeq.R --no-save --no-restore --args $Project/$name/$file
...
~/Scripts/v3.1_pipeline/v3.1_primer_summary.sh
