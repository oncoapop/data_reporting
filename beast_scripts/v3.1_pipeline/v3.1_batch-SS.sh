...
# 7 Feb 2014 and 11 Feb 2014
for sample in SA501sc
...
#-----------------------------DO NOT EDIT ANYTHING BELOW THIS LINE -------------------------------------
	...
	cp $inpath"/"$sample"/set2/"$sample"_primer3_output.txt" $p3dir"/"$sample"_primer3_output.txt"
