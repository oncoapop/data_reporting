...
~/Scripts/v4.4_pipeline/v4.4_inSilicoPcr.sh
...
# Rscript ~/Scripts/v4.4_pipeline/v4.4_GetSeq.R --no-save --no-restore --args $Project/$name/$file
...
~/Scripts/v4.4_pipeline/v4.4_primer_summary.sh
