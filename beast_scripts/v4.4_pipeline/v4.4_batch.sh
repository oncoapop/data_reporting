...
#	nohup ~/Scripts/v4.4_pipeline/v4.4_display_pipeline.sh $Project $sample $reads && echo `date` \r >> ~/Projects/PrimerDesign/jobs.log; echo $sample "completed using v3.1." >> ~/Projects/PrimerDesign/jobs.log
	~/Scripts/v4.4_pipeline/v4.4_display_pipeline.sh $Project $sample $reads
