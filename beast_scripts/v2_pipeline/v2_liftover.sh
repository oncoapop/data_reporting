...
basedir="/meta/o/oncoapop"
projdir=$basedir"/Projects/Pipeline/"$Project"/"$sample
wd=$projdir"/positions"
p3dir=$projdir"/primer3"

liftover=$basedir"/Apps/liftOver"
chain=$basedir"/data/annotations/hg18ToHg19.over.chain"
