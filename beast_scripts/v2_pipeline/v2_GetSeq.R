...
# Command line `Rscript v2_GetSeq.R --no-save --no-restore --args $dir/$sample/$file`
...
# source(file="/meta/o/oncoapop/Scripts/v2_pipeline/v2_GetSeq.R")
...
homebase="/meta/o/oncoapop/Projects/Pipeline"
setwd(homebase)
# all files from this point should be hg19
hg19file=paste(posfile, "hg19", sep="-")

# commented lines are Done by v2_primerdesign.cgi
