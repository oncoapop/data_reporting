...
~/Scripts/v2.8_pipeline/v2.8_inSilicoPcr.sh
...
Rscript ~/Scripts/v2.8_pipeline/v2.8_GetSeq.R --no-save --no-restore --args $Project/$name/$file
...
~/Scripts/v2.8_pipeline/v2.8_primer_summary.sh
