...
# install.packages("/share/Monco/MOLabSoftware/R/MOutils/MOutils_1.5.tar.gz", 
# 		repos= NULL, type="source")
require("MOutils")

wd="/share/scratch/dyap_temp/"
...
pdf('./Plots/qPCRplotsMLL5_test.pdf', width=10, height=8)
require("lattice")
require("grid")
...
write.csv(modelResults, file = "qPCR.MLL5.test.modelResults.csv")
